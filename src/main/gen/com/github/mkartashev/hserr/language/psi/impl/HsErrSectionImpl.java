...
public class HsErrSectionImpl extends ASTWrapperPsiElement implements HsErrSection {

  public HsErrSectionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<HsErrSubsection> getSubsectionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, HsErrSubsection.class);
  }
